...
function App() {
    ...
    const url_animals =`https://apis.data.go.kr/1543061/abandonmentPublicSrvc/abandonmentPublic?serviceKey=${API_KEY}&upkind=417000&upr_cd=${sido}&org_cd=${sigungu}&pageNo=${pageNo}&numOfRows=${numOfRows}&_type=${_type}`;
        ...
        {animal_list === undefined || animal_list.length === 0 ? 
            ...
            <ul className="animal-list">
                {animal_list.map((item) => (
                    <li key={item.desertionNo} className="item">
